...
# Go module proxy — use JFrog Artifactory virtual repository (corporate network requirement)
# Uses afs-vgo-proxy (virtual repo) which aggregates remote Go repositories
